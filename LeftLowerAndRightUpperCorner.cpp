...
#include "LeftLowerAndRightUpperCorner.h"
#include "PaperSprite.h"

// Sets default values
ALeftLowerAndRightUpperCorner::ALeftLowerAndRightUpperCorner()
{
	// Set this actor to call Tick() every frame.  You can turn this off to improve performance if you don't need it.
	PrimaryActorTick.bCanEverTick = true;
	
	UPaperSprite* Sprite = Cast<UPaperSprite>(StaticLoadObject(UPaperSprite::StaticClass(), nullptr, TEXT("PaperSprite'/Game/GameAssets/Walls/Corners/LeftLowerCorner_Texture_Sprite.LeftLowerCorner_Texture_Sprite'")));
	...
	// LightBlocker2->SetVisibility(true); // For Debug
	// LightBlocker2->SetHiddenInGame(false); // For Debug
	

}

// Called when the game starts or when spawned
void ALeftLowerAndRightUpperCorner::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void ALeftLowerAndRightUpperCorner::Tick(float DeltaTime)
{
