...
AFlower::AFlower()
{
	...
	UPaperSprite* Sprite = Cast<UPaperSprite>(StaticLoadObject(UPaperSprite::StaticClass(), nullptr, TEXT("PaperSprite'/Game/GameAssets/Decor/FLORIH_Sprite.FLORIH_Sprite'")));
